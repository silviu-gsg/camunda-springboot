...
public final class OriginationProcessConstants {
    ...
    public static final String VALIDATION_ERROR_TASK_ID = "validation_error_notification";
    public static final String WELCOME_ABOARD_TASK_ID = "welcome_aboard_notification";
